...
int minFontSize = EntityUtilProperties.getPropertyAsInteger("brit", "tagcloud.min.fontsize", 0).intValue()
int maxFontSize = EntityUtilProperties.getPropertyAsInteger("brit", "tagcloud.max.fontsize", 0).intValue()
int limitTagCloud = EntityUtilProperties.getPropertyAsInteger("brit", "tagcloud.limit", 0).intValue()
