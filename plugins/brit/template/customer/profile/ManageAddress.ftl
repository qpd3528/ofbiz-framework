...
<div class="screenlet clearfix">
  ...
  <h3>${uiLabelMap.BritAddressBook}</h3>
  <div class="screenlet-body">
    <#-- Add address -->
    <a class="button" id="addAddress" href="javascript:void(0)">${uiLabelMap.BritAddNewAddress}</a>
      ...
      <form id="createPostalAddressForm" method="post" action="">
        <fieldset>
          ...
          <div class="form-check">
            ...
            <label for="setBillingPurpose">${uiLabelMap.BritMyDefaultBillingAddress}</label>
          </div>
          <div class="form-check">
            ...
            <label for="setShippingPurpose">${uiLabelMap.BritMyDefaultShippingAddress}</label>
          </div>
        </fieldset>
      </form>
    </div>
  ...
  <div class="left center">
    <h3>${uiLabelMap.BritDefaultAddresses}</h3>
    <div class="screenlet-body">
    <#--===================================== Billing Address and Telecom number ====================================-->
      <h3>${uiLabelMap.BritPrimaryBillingAddress}</h3>
      <ul>
    ...
    <#--===================================== Shipping Address and Telecom number ===================================-->
      <h3>${uiLabelMap.BritPrimaryShippingAddress}</h3>
      <ul>
  ...
  <div class="center right">
    <h3>${uiLabelMap.BritAdditionalAddresses}</h3>
