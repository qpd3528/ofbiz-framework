...
<div class="screenlet">
  <h3>${uiLabelMap.BritMyAccount}</h3>
  <div class="screenlet-body clearfix">
    <div>
      <a class="button" href="<@ofbizUrl>editProfile</@ofbizUrl>">${uiLabelMap.BritEditProfile}</a>
    ...
    <#-- Manage Addresses -->
    <div>
      <a class="button" href="<@ofbizUrl>manageAddress</@ofbizUrl>">${uiLabelMap.BritManageAddresses}</a>
