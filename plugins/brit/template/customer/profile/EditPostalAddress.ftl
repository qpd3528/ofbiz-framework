...
<form id="editPostalAddress_${contactMech.contactMechId}" method="post" action="">
  <fieldset>
    ...
    <div class="form-check">
      ...
      <label for="setBillingPurposeForPostalAddress">${uiLabelMap.BritMyDefaultBillingAddress}</label>
    </div>
    <div class="form-check">
      ...
      <label for="setShippingPurposeForPostalAddress">${uiLabelMap.BritMyDefaultShippingAddress}</label>
    </div>
      <#--
    <div>
