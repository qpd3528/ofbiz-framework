...
<#macro showMessage communicationEvent isSentMessage index>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="javascript:document.ecomm_read_mess${index}.submit()">${uiLabelMap.BritRead}</a>
      <#if isSentMessage>
    ...
    <table class="table table-responsive-sm">
      <thead class="thead-light">
        <tr>
          ...
          <th>
            ${uiLabelMap.BritSubject}
          </th>
          <th>
            ${uiLabelMap.BritSentDate}
          </th>
          <th></th>
        </tr>
      </thead>
