...
<div class="card m-3">
  <div class="card-header">
    <strong>${uiLabelMap.BritReadMessage}</strong>
    <#if (communicationEvent.partyIdFrom! != (userLogin.partyId)!)>
      ...
      <a href="<@ofbizUrl>messagelist</@ofbizUrl>" class="float-right">${uiLabelMap.BritViewList}</a>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-1">
    ...
    <div class="row">
      <div class="col-1">
        <strong>${uiLabelMap.BritSubject} :</strong>
      </div>
      <div class="col-11">
        ${(communicationEvent.subject)?default("[${uiLabelMap.BritNoSubject}]")}
      </div>
    </div>
    <hr/>
    <div class="row">
      ...
      <div class="col-11">
        ${StringUtil.wrapString(communicationEvent.content)?default("[${uiLabelMap.BritEmptyBody}]")}
      </div>
    </div>
  </div>
</div>
