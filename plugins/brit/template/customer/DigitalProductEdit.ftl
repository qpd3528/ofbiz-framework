...
<div class="screenlet">
  ...
  <#if !supplierProduct?has_content && parameters.productId?has_content>
    <div><h3>${uiLabelMap.BritMessage1} [${parameters.productId}] ${uiLabelMap.BritMessage2}</h3></div>
  <#else>
    <#if !supplierProduct??>
      <h1>${uiLabelMap.BritAddNewDigitalProduct}</h1>
    ...
    <#else>
      <h1>${uiLabelMap.BritUpdateDigitalProduct}</h1>
...
<#if supplierProduct?has_content>
  <div class="screenlet">
    ...
    <div class="screenlet-body">
      ...
      <div class="tableheadtext">${uiLabelMap.BritDigitalAddFromMyFiles}</div>
      <div>
