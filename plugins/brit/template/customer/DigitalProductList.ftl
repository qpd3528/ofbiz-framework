  ...
  <div class="screenlet-body">
    <div>&nbsp;
      <a href="<@ofbizUrl>digitalproductedit</@ofbizUrl>" class="buttontext">
        ${uiLabelMap.BritDigitalNewProduct}
      </a>
    </div>
    ...
    <#if !supplierProductList?has_content>
      <tr>
        <td colspan="5"><h3>${uiLabelMap.BritNoDigitalProductsFound}</h3></td>
      </tr>
    </#if>
    </table>
  </div>
...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <div class="h3">${uiLabelMap.BritDigitalProductPurchaseHistoryCommission}</div>
  </div>
  <div class="screenlet-body">
    <div>&nbsp;
      <a href="<@ofbizUrl>digitalproductedit</@ofbizUrl>" class="buttontext">
