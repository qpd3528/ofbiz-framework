...
<script type="application/javascript">
        ...
        function gwAll(e) {
            ...
            if (cartSize > passed && selectedValue != "NO^") {
                showErrorAlert("${uiLabelMap.CommonErrorMessage2}","${uiLabelMap.BritSelectedGiftWrap}");
            }
            cform.submit();
        }
</script>
...
<div class="card">
    <div class="card-header">
      ...
      <a href="<@ofbizUrl>${continueLink}</@ofbizUrl>" class="submenutext">
        ${uiLabelMap.BritContinueShopping}
      </a>
    ...
    <div>
      <form method="post"
        ...
        <div class="form-group mb-2">
          <label for="add_product_id" class="mr-2"> ${uiLabelMap.BritProductNumber} </label>
...
<div>
      ...
      <ul class="list-inline">
        ...
        <#if (shoppingCartSize > 0)>
          ...
          <a href="javascript:document.cartform.submit();">
            ${uiLabelMap.BritRecalculateCart}
          </a>
          </li>
          <li class="list-inline-item">
          <a href="<@ofbizUrl>emptycart</@ofbizUrl>">
            ${uiLabelMap.BritEmptyCart}
          </a>
          </li>
          <li class="list-inline-item">
          <a href="javascript:removeSelected();">
            ${uiLabelMap.BritRemoveSelected}
          </a>
          </li>
        <#else>
          <li class="list-inline-item">
          <span class="submenutextdisabled">${uiLabelMap.BritRecalculateCart}</span>
          </li>
          <li class="list-inline-item">
          <span class="submenutextdisabled">${uiLabelMap.BritEmptyCart}</span>
          </li>
          <li class="list-inline-item">
          <span class="submenutextdisabled">${uiLabelMap.BritRemoveSelected}</span>
          </li>
        </#if>
      </ul>
    </div>
  ...
  <div>
              ...
              <tr>
                ...
                <#if asslGiftWraps?has_content && productStore.showCheckoutGiftOptions! != "N">>
                  <th scope="row">
                    <select class="form-control" name="GWALL" onchange="javascript:gwAll(this);">
                      <option value="">${uiLabelMap.BritGiftWrapAllItems}</option>
                      <option value="NO^">${uiLabelMap.BritNoGiftWrap}</option>
                ...
                <#if fixedAssetExist == true>
                  <td>
                    <table>
                      <tr>
                        <td>- ${uiLabelMap.BritStartDate} -</td>
                        <td>- ${uiLabelMap.BritNbrOfDays} -</td>
                      </tr>
                      <tr>
                        <td >- ${uiLabelMap.BritNbrOfPersons} -</td>
                ...
                <th class="amount">${uiLabelMap.BritUnitPrice}</th>
                <th class="amount">${uiLabelMap.BritAdjustments}</th>
                <th class="amount">${uiLabelMap.BritItemTotal}</th>
                <th>
                ...
                <tr id="cartItemDisplayRow_${cartLineIndex}">
                  ...
                  <td >
                    ...
                    <#elseif showNoGiftWrapOptions>
                      <select class="selectBox" name="option^GIFT_WRAP_${cartLineIndex}"
                          onchange="">
                        <option value="">${uiLabelMap.BritNoGiftWrap}</option>
                      </select>
                    <#else>
                      &nbsp;
                    </#if>
          ...
          <tfoot>
            ...
            <#if shoppingCart.getAdjustments()?has_content>
              ...
              <#list shoppingCart.getAdjustments() as cartAdjustment>
                ...
                <tr>
                  <th colspan="6">
                    ${uiLabelMap.BritAdjustment} - ${adjustmentType.get("description",locale)!}
            ...
            <tr>
              <th colspan="6">${uiLabelMap.BritCartTotal}:</th>
              <td class="amount" colspan="1">
            ...
            <#if itemsFromList>
              <tr>
                <td colspan="8">L - ${uiLabelMap.BritItemsfromShopingList}.</td>
              </tr>
            </#if>
            <#if promoItems>
              <tr>
                <td colspan="8"><span class="badge badge-success">P</span> - ${uiLabelMap.BritPromotionalItems}.</td>
              </tr>
            </#if>
              ...
              <td colspan="8">
                <#if sessionAttributes.userLogin?has_content && sessionAttributes.userLogin.userLoginId != "anonymous">
                  ...
                  <a href="javascript:addToList();" class="btn btn-outline-secondary">
                    ${uiLabelMap.BritAddSelectedtoList}
                  </a>
                  </span>
                  </div>
                <#else>
            ...
            <tr>
              <td colspan="8">
                ...
                <#else>
                  ...
                  ${uiLabelMap.BritToOrderCreateCustRequestFromCart}.&nbsp;
                </#if>
              </td>
            </tr>
            <tr>
              <td colspan="8">
                ...
                <label>${uiLabelMap.BritAlwaysViewCartAfterAddingAnItem}.</label>
               </div>
              </td>
            </tr>
          </tfoot>
    ...
    <#else>
      <h3>${uiLabelMap.BritYourShoppingCartEmpty}.</h3>
    </#if>
...
<#if associatedProducts?has_content>
  <div class="card">
    <div class="card-header">
      <h3>${uiLabelMap.BritYouMightAlsoIntrested}:</h3>
    </div>
    <div class="card-body">
      ...
      <#list associatedProducts as assocProduct>
          ...
          ${screens.render("component://brit/widget/CatalogScreens.xml#productsummary")}
...
<#if (shoppingCartSize?default(0) > 0)>
  ${screens.render("component://brit/widget/CartScreens.xml#promoUseDetailsInline")}
</#if>