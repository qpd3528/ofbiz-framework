...
<#if shoppingCart?has_content && shoppingCart.size() &gt; 0>
  <div class="card">
    <div class="card-header bg-info text-white">${uiLabelMap.BritStep} 1: ${uiLabelMap.PageTitleShoppingCart}</div>
    <div class="card-body">
    ...
    <table class="table table-responsive-sm" id="cartSummaryPanel_cartItems" summary="This table displays the list of item added into Shopping Cart.">
      <thead class="thead-light">
        <tr>
          ...
          <th id="unitPrice" class="amount">${uiLabelMap.BritUnitPrice}</th>
          <th id="quantity">${uiLabelMap.OrderQuantity}</th>
          <th id="adjustment" class="amount">${uiLabelMap.BritAdjustments}</th>
          <th id="itemTotal" class="amount">${uiLabelMap.BritItemTotal}</th>
        </tr>
      </thead>
      <tfoot>
    ...
    <a href="javascript:void(0);" id="openCartPanel" class="btn btn-outline-secondary">${uiLabelMap.BritClickHereToEdit}</a>
  </div>
  <div id="editCartPanel">
    <form id="cartForm" method="post" action="<@ofbizUrl></@ofbizUrl>">
        ...
        <table class="table table-responsive-sm" id="editCartPanel_cartItems">
          <thead class="thead-light">
            <tr>
              ...
              <th id="editUnitPrice" class="amount">${uiLabelMap.BritUnitPrice}</th>
              <th id="editQuantity">${uiLabelMap.OrderQuantity}</th>
              <th id="editAdjustment" class="amount">${uiLabelMap.BritAdjustments}</th>
              <th id="editItemTotal" class="amount">${uiLabelMap.BritItemTotal}</th>
                  ...
                  <td>
                    <a id="removeItemLink_${cartLine_index}" href="javascript:void(0);">
                      <img id="remove_${cartLine_index}"
                          src="<@ofbizContentUrl>/brit/images/remove.png</@ofbizContentUrl>"
        ...
        <div class="form-group">
          <label for="productPromoCode" class="mx-2">${uiLabelMap.BritEnterPromoCode}</label>
        ...
        <a href="javascript:void(0);" class="btn btn-primary" id="updateShoppingCart" >
          ${uiLabelMap.BritContinueToStep} 2
        </a>
