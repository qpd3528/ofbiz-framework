  ...
  <ul class="list-inline">
    ...
    <#if (shoppingCartSize > 0)>
      ...
      <li class="list-inline-item" id="onePageCheckoutEnabled">
        <a href="<@ofbizUrl>onePageCheckout</@ofbizUrl>">[${uiLabelMap.BritOnePageCheckout}]</a>
      </li>
      <li class="list-inline-item disabled" id="onePageCheckoutDisabled" style="display:none">
        [${uiLabelMap.BritOnePageCheckout}]
      </li>
    ...
    <#else>
      ...
      <li class="list-inline-item disabled">[${uiLabelMap.BritOnePageCheckout}]</li>
    </#if>
  </ul>
</div>