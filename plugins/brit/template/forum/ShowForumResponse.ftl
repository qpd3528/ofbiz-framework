...
<div class="screenlet">
  <h1>{${uiLabelMap.BritFromSite}</h1><br/>
  <div>
    ...
    <#else>
      ...
      <br/>
      <h1>${uiLabelMap.BritContentFor} [${subContentId}] ${subContent.contentName!}
    ...
    <table border="0" width="100%" class="tableheadtext">
      ...
      -->
      <h1>${uiLabelMap.BritResponses}</h1><br/>
