...
<#if processResult>
  <#-- success -->
  <br/>
  ${uiLabelMap.BritYourGiftCard} ${displayNumber} ${uiLabelMap.BritYourGiftCardReloaded}
  <br/>
  ${uiLabelMap.BritGiftCardNewBalance} ${amount} ${uiLabelMap.CommonFrom} ${previousAmount}
  <br/>
<#else>
  <#-- fail -->
  <br/>
  ${uiLabelMap.BritGiftCardReloadFailed} ${responseCode}
  <br/>
  ${uiLabelMap.BritGiftCardRefunded}
  <br/>
</#if>
