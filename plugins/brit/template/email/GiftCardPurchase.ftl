...
${uiLabelMap.BritYouHaveBeenSent} MyCompany.com
<#if senderName??> ${uiLabelMap.BritGiftCardFrom} ${senderName}</#if>!
<br/><br/>
...
<pre>
  ${uiLabelMap.BritYourCardNumber} ${cardNumber!}
  ${uiLabelMap.BritYourPinNumber} ${pinNumber!}
  ${uiLabelMap.BritGiftAmount} ${amount!}
</pre>
