...
$(document).ready(function() {
  if (jQuery.fn.bsgdprcookies !== undefined) {
    jQuery('body').bsgdprcookies({
        title: '${uiLabelMap.BritCookieConsentTitle}',
        message: '${uiLabelMap.BritCookieConsentMessage}',
        moreLink: '/brit/control/CookiePolicy',
        moreLinkLabel: ' ${uiLabelMap.BritCookieConsentMoreLinkLabel}',
        acceptButtonLabel: '${uiLabelMap.BritCookieConsentAcceptButtonLabel}',
        advancedButtonLabel: '${uiLabelMap.BritCookieConsentAdvancedButtonLabel}',
...
<div class="container-fluid">
  <div class="row align-items-center">
    ...
    <div class="col text-center d-none d-lg-block">
      <#if !productStore??>
            <h3>${uiLabelMap.BritNoProductStore}</h3>
          </#if>
    ...
    <div class="col">
      ${screens.render("component://brit/widget/CartScreens.xml#microcart")}
    </div>
  </div>
</div>
  ...
  <div class="collapse navbar-collapse" id="navbarContent">
    <ul class="navbar-nav mr-auto">
      ...
      <#else>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<@ofbizUrl>newcustomer</@ofbizUrl>">${uiLabelMap.BritRegister}</a>
        </li>
      </#if>
      <li class="nav-item">
        <#if userLogin?has_content && userLogin.userLoginId != "anonymous">
    ...
    <ul class="navbar-nav ml-auto">
      <#if !userLogin?has_content || (userLogin.userLoginId)! != "anonymous">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<@ofbizUrl>editShoppingList</@ofbizUrl>">${uiLabelMap.BritShoppingLists}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<@ofbizUrl>orderhistory</@ofbizUrl>">${uiLabelMap.BritOrderHistory}</a>
        </li>
      </#if>
