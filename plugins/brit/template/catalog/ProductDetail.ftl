...
<div id="product-detail" class="card">
  ...
  <div class="card-body">
    ...
    <div class="col-lg-8">
      ...
      <#-- show tell a friend details only in brit application -->
      <div>&nbsp;</div>
      <div>
  ...
  <hr>
    <div class="product-tags">
      <h4>${uiLabelMap.BritProductTags}</h4>
    <#if productTags??>
      <p class="titleAddTags"><strong>${uiLabelMap.BritProductTagsDetail}:</strong></p>
        <ul>
          <li>
            <#assign no = 0 />
    ...
    <div class="form-group">
      <label>${uiLabelMap.BritAddYourTags}:</label>
      <form method="post" action="<@ofbizUrl>addProductTags</@ofbizUrl>" name="addProductTags">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn"><input class="buttonProductTags btn btn-outline-secondary" type="submit" value="${uiLabelMap.BritAddTags}" name="addTag"/></span>
        </div>
      </form>
    </div>
      <span>${uiLabelMap.BritAddTagsDetail}</span>
