        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="sortAscendingHigh">${uiLabelMap.BritLowToHigh}</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="sortAscending" id="sortAscendingLow" value="N"/>
              <label class="form-check-label" for="sortAscendingLow">${uiLabelMap.BritHighToLow}</label>
            </div>
          </div>
        </div>
      </fieldset>
      ...
      <div class="card m-3">
        ...
        <div class="card-body">
          ...
          <#-- searchOptions type is ProductSearchSession.ProductSearchOptions -->
            <div>
              <p>${uiLabelMap.BritSearchNumber}${searchOptions_index + 1}</p>
