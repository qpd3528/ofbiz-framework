...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div class="screenlet">
        ...
        ${screens.render("component://brit/widget/OrderScreens.xml#quickAnonPaymentInformation")}
    </td>
            ...
            <#list orderItemShipGroups as shipGroup>
              ...
              <table width="100%" border="0" cellpadding="1">
                <#if shippingAddress?has_content>
                  ...
                  <tr><td colspan="7">
                     ${screens.render("component://brit/widget/OrderScreens.xml#quickAnonOptionSettings")}
                  </td></tr>
              </table>
