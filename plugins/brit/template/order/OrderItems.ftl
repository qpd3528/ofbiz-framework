...
<#-- NOTE: this template is used for the orderstatus screen in brit AND for order notification emails through the OrderNoticeEmail.ftl file -->
<#-- the "urlPrefix" value will be prepended to URLs by the ofbizUrl transform if/when there is no "request" object in the context -->
<#if baseBritSecureUrl??><#assign urlPrefix = baseBritSecureUrl/></#if>
<div class="card">
          ...
          <tr>
            ...
            ${uiLabelMap.BritAdjustment}
              ...
              <#if "SALES_TAX" == orderItemAdjustment.orderAdjustmentTypeId>
                ...
                <#if orderItemAdjustment.sourcePercentage??>${uiLabelMap.BritRate}
                ...
                <#if orderItemAdjustment.exemptAmount??>${uiLabelMap.BritExemptAmount}
