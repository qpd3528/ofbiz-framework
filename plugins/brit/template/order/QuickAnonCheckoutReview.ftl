...
<#if cart?? && 0 < cart.size()>
  ${screens.render("component://brit/widget/OrderScreens.xml#quickAnonOrderHeader")}
  <br />
  <div id="orderItemsSection">${screens.render("component://brit/widget/OrderScreens.xml#orderitems")}</div>
